...
***************************************************************************** */
        ...
        function applyMask(digits) {
            let result = "";
            let di = 0;
            for (let i = 0; i < mask.length; i++) if (mask[i] === "_") result += di < digits.length ? digits[di++] : "_"; else result += mask[i];
            return result;
        }
        ...
        playBtn.addEventListener("click", (() => {
            lightgallery_es5(document.body, {
                dynamic: true,
                dynamicEl: [ {
                    src: "img/marikarkasvideo.webm",
                    thumb: "img/main/main-text-img.svg",
                    poster: "img/main/main-text-img.svg",
                    subHtml: "<h4>Видео</h4>"
                } ],
                plugins: [ lg_video_min ],
                licenseKey: "7EC452A9-0CFD441C-BD984C7C-17C8456E",
