...
***************************************************************************** */
        ...
        function phoneMask(input) {
            input.addEventListener("input", (function(e) {
                ...
                if (value.length > 1) {
                    ...
                    if (!allowed.includes(value[1])) value = value[0];
                }
                let formatted = "+7 (";
            ...
            input.addEventListener("keydown", (function(e) {
                ...
                if (pos <= 3 && (e.key === "Backspace" || e.key === "Delete")) e.preventDefault();
                if (pos === 4 && e.key >= "0" && e.key <= "9") {
                    const allowed = [ "0", "1", "3", "4", "5", "6", "7", "9" ];
                    if (!allowed.includes(e.key)) e.preventDefault();
                }
                if (!(e.key >= "0" && e.key <= "9" || [ "Backspace", "Delete", "ArrowLeft", "ArrowRight" ].includes(e.key))) e.preventDefault();
            }));
        }
        ...
        const sendFormCalc = document.getElementById("calc-form");
        const calcErrMessage = document.querySelector(".form-error-calc");
        ...
        function renderStep() {
            ...
            if (answers[fieldName]) if (inputs[0].type === "radio") inputs.forEach((i => {
            ...
            if (inputs[0]) if (inputs[0].type === "radio") nextBtn.disabled = !Array.from(inputs).some((i => i.checked)); else nextBtn.disabled = !(answers[fieldName] && answers[fieldName].length > 0); else nextBtn.disabled = true;
        ...
        if (quizForm) {
            quizForm.addEventListener("submit", (async e => {
                ...
                for (let key in answers) message += `${key}: ${answers[key]}\n`;
                console.log(message);
                try {
